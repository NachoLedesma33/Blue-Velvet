  ...
  return (
    <div className="bg-white">
      ...
      <main>
        ...
        {/* About strip */}
        <section id="nosotros" className="py-16 sm:py-20 bg-cream-50">
          <div className="container-wide px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-14 items-center">
              <div className="space-y-5 sm:space-y-6">
                ...
                <h2 className="font-display text-3xl sm:text-4xl font-semibold text-navy-800 leading-tight text-balance">
        ...
        {/* Instagram CTA */}
        <section className="py-16 sm:py-20 bg-navy-gradient text-white overflow-hidden relative">
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute top-6 left-6 sm:top-10 sm:left-10 w-24 h-24 sm:w-40 sm:h-40 bg-white/5 blob" />
            <div className="absolute bottom-6 right-6 sm:bottom-10 sm:right-10 w-20 h-20 sm:w-32 sm:h-32 bg-silver-300/10 blob" style={{ animationDelay: '3s' }} />
          </div>
          <div className="relative z-10 container-wide px-4 sm:px-6 lg:px-8 text-center">
            <div className="max-w-xl mx-auto">
              <div className="w-12 h-12 sm:w-14 sm:h-14 bg-white/15 rounded-2xl flex items-center justify-center mx-auto mb-5 sm:mb-6">
              ...
              <h2 className="font-display text-2xl sm:text-3xl sm:text-4xl font-semibold text-white mb-3 sm:mb-4">
                Seguinos en Instagram
              </h2>
              <p className="text-silver-300 font-body text-sm sm:text-base leading-relaxed mb-6 sm:mb-8">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 sm:gap-3 bg-white text-navy-800 px-6 sm:px-8 py-3.5 sm:py-4 rounded-full font-body font-semibold text-xs sm:text-sm hover:bg-cream-50 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl"
              >
                @bluevelvetpastry
              </a>
            </div>
